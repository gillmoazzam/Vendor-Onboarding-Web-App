...
export const requests: VendorRequest[] = [
  {
    ...
    questionnaireStatus: 'Not Started', questionnaireToken: null, questionnaireSentDate: null, questionnaireSubmittedDate: null, questionnaireApprovedBy: null, answers: emptyAnswers,
  },
  {
