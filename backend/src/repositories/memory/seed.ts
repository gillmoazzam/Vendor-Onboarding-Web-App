...
export const requests: VendorRequest[] = [
  {
    ...
    status: 'Approved', approverComments: 'Approved for vendor onboarding.', approvalDate: '2026-08-02T10:00:00.000Z', createdVendorId: null,
    questionnaireStatus: 'Not Started', questionnaireSubmittedDate: null, vendorComments: '', answers: emptyAnswers,
  },
  {
    ...
    status: 'Approved', approverComments: 'Client requirement confirmed.', approvalDate: '2026-08-04T10:00:00.000Z', createdVendorId: null,
    questionnaireStatus: 'Not Started', questionnaireSubmittedDate: null, vendorComments: '', answers: emptyAnswers,
  },
]
